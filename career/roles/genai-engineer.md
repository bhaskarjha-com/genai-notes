...
|---|---|---|:---:|
| Enterprise GenAI assistant | Multi-source RAG assistant with eval dashboard | RAG, eval, deployment | Medium |
| Agentic operations copilot | Tool-using agent with approvals and observability | Agents, protocols, LLMOps | Medium |
