...
- [Transformers](./transformers.md) — encoder/decoder, self-attention
- [Attention Mechanism](./attention-mechanism.md) — Q, K, V matrices
- [Linear Algebra For Ai](../prerequisites/linear-algebra-for-ai.md) — matrix operations
