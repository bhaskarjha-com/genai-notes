...
Covers: Vision-language models, text-to-video, text-to-audio, and cross-modal understanding. For image generation specifically, see [[../image-generation/diffusion-models]]. For the text-only LLM perspective, see [[../llms/llms-overview]].
...
- [[../llms/llms-overview]] — the text foundation
- [[../foundations/transformers]] — attention across modalities
