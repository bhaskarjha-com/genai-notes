...
aliases: ["LLMOps", "ML Operations for LLMs"]
...
| Type       | Resource                                                                          | Why                                                  |
| ---------- | --------------------------------------------------------------------------------- | ---------------------------------------------------- |
| ðŸ“˜ Book     | "AI Engineering" by Chip Huyen (2025), Ch 8-9                                     | Definitive treatment of LLMOps patterns              |
| ðŸ“˜ Book     | "Designing Machine Learning Systems" by Chip Huyen (2022)                         | MLOps foundations that LLMOps builds on              |
