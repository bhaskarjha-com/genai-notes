...
**Goal**: Understand how β affects DPO training behavior
**Time**: 60 minutes
**Steps**:
1. Using the same preference dataset, train 3 DPO models: β=0.05, β=0.1, β=0.5
2. For each, measure: training loss, reward margin (chosen - rejected log prob), and generation quality
3. Compare: which β gives best task quality? Which preserves general capability best?
4. Create a recommendation for your use case
**Expected Output**: Table comparing 3 β values across quality, safety, and capability retention metrics
